...
RUN sh -c 'echo "deb http://mirrors.ustc.edu.cn/ros/ubuntu/ bionic main" > /etc/apt/sources.list.d/ros-latest.list'
...
COPY __init__.py /usr/lib/python2.7/dist-packages/rosdistro/__init__.py
RUN rosdep update
